        ...
        return HealthResponse(
            ...
            components=[
                ...
                ComponentHealth(
                    ...
                    status="operational",
                    detail=(
                        "FirewallV2 deterministic policy is operational and ready for "
                        "framework-neutral interception requests."
                    ),
                ),
            ],
        )
...
def guard_evaluation_from_payload(payload: dict) -> GuardEvaluationView:
    ...
    return GuardEvaluationView(
        ...
        intent_contract=evaluation.get("intent_contract"),
        intent_authorization=evaluation.get("intent_authorization"),
        evaluation_plan=evaluation.get("evaluation_plan"),
