const styles: Record<string, string> = {
  ...
  "observe only": "bg-blue-100 text-blue-700",
  observe_only: "bg-blue-100 text-blue-700",
  disabled: "bg-slate-100 text-slate-600",
  placeholder: "bg-[var(--amber-bg)] text-[var(--amber)]",
  "not implemented": "bg-slate-100 text-slate-600",
  not_implemented: "bg-slate-100 text-slate-600",
